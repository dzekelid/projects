...
- name: Google Cloud SQL API Delete Projects Project Instances Instance Backupruns
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/projects/master/_listings/google-cloud-sql/projects-project-instances-instance-backupruns-id-delete.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/projects/master/_listings/google-cloud-sql/projects-project-instances-instance-backupruns-id-delete-postman.md
x-common:
- type: x-change-log
